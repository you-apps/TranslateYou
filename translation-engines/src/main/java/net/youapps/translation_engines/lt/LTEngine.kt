...
package net.youapps.translation_engines.lt
...
class LTEngine(settingsProvider: EngineSettingsProvider) : TranslationEngine(settingsProvider) {
    override val name = "LibreTranslate"
    override val defaultUrl = "https://libretranslate.com"
